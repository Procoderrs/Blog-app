...
export default function FullPost() {
  console.log("full-post-page-render");
  ...
  /**
   * Fetch single post by slug on component mount or when slug changes
   */
  useEffect(() => {
    const fetchPost = async () => {
      try {
        ...
        }); // Ensure backend supports fetching a single post by slug
        ...
        <div className="max-w-4xl mx-auto my-10 bg-white rounded-2xl shadow-sm overflow-hidden">
          ...
          <div className="p-6 md:p-8">
            ...
            <div className="flex flex-wrap items-center gap-3 text-sm text-gray-500 mb-4">
              ...
              <span>•</span>
              <span className="font-medium text-[#3B3363]">{post.author?.name}</span>
            </div>
            ...
            {/* Blog Content */}
            <div
              className=" blog-content max-w-none prose-headings:text-[#3B3363] prose-p:text-gray-700"
